# UD 15 - Herramientas para proyectos


- [UD 15 - Herramientas para proyectos](#ud-15-herramientas-para-proyectos)
   * [1. Autenticación](#1-autenticación)
      + [1.1 Store](#11-store)
      + [1.2 API](#12-api)
      + [1.3 Login.vue](#13-loginvue)
      + [1.4 Router](#14-router)
   * [2. Paso a producción](#2-paso-a-producción)
   * [3. Vuetify](#3-vuetify)
      + [3.1 Instalación](#31-instalación)
      + [3.2 Crear el layout](#32-crear-el-layout)
      + [3.3 Saber más](#33-saber-más)
   * [4. Typescript](#4-typescript)
   * [5. SSR (Server Side Rendering)](#5-ssr-server-side-rendering)
   * [6. Crear aplicaciones móviles con Vue](#6-crear-aplicaciones-móviles-con-vue)
      + [6.1 Quasar](#61-quasar)
      + [6.2 Vue Native](#62-vue-native)
      + [6.3 Ionic Vue](#63-ionic-vue)
   * [7. Nuxt](#7-nuxt)
   * [8. Conclusión](#8-conclusión)
   * [9. Angular](#9-angular)
   * [10. Vue con Laravel](#10-vue-con-laravel)
      + [10.1 Creación del proyecto](#101-creación-del-proyecto)
      + [10.2 Configuramos el proyecto en Vue](#102-configuramos-el-proyecto-en-vue)
      + [10.3 Configuramos Laravel](#103-configuramos-laravel)
      + [10.4 Compilamos Vue](#104-compilamos-vue)
      + [10.5 Creamos la API](#105-creamos-la-api)
      + [10.6 Saber más](#106-saber-más)
...
## 6. Crear aplicaciones móviles con Vue
...
### 10.2 Configuramos el proyecto en Vue
