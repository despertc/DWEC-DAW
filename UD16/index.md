...
- [UD16 - Pinia](#ud15-pinia)
   * [1. Introducción](#1-introducción)
   * [2. Instalar y configurar Pinia](#2-instalar-y-configurar-pinia)
   * [3. Crear un store](#3-crear-un-store)
   * [4. Usar Pinia](#4-usar-pinia)
      + [4.1 Getters](#41-getters)
      + [4.2 Actions](#42-actions)
   * [5. state en formularios](#5-state-en-formularios)
